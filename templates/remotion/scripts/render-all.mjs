...
//   node scripts/render-all.mjs MetricReveal     -> render only these ids
//   node scripts/render-all.mjs --still          -> render a poster PNG per shot instead of video
// Opaque shots -> out/<id>.mp4 (h264, crf 18). transparent:true shots -> out/<id>.mov
// (ProRes 4444 + alpha, yuva444p10le).
...
// the programmatic bundle() API. public/ is the project's own static-asset root.
